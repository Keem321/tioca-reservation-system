			...
			<div className="privacy-page__container">
				<div className="privacy-page__content">
					...
					<section className="privacy-section">
						<h2>Introduction</h2>
						<p>
							Welcome to TIOCA (Tapioca Pod Hotel). We are committed to
					...
					<section className="privacy-section">
						...
						<p>
							When you make a reservation at TIOCA, we collect personal
					...
					<section className="privacy-section">
						...
						<p>
							Your payment information is processed securely through our
							PCI-compliant payment provider and is never stored on our servers.
						</p>
					</section>
					...
					<section className="privacy-section">
						...
						<p>
							TIOCA is located in Japan. If you are accessing our services from
							outside Japan, please be aware that your information may be
							transferred to, stored, and processed in Japan or other countries
					...
					<section className="privacy-section">
						...
						<ul className="contact-info">
							...
							<li>
								<strong>Mail:</strong> TIOCA Pod Hotel, 3-14-8 Kabukicho,
