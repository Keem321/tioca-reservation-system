...
const SessionTimeoutTest: React.FC = () => {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '2rem', padding: '1rem', background: '#f5f1e8', borderRadius: '8px' }}>
        <h2>Instructions:</h2>
        <ol>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <h3>Current State:</h3>
        <ul>
          <li>Modal Visible: <strong>{showModal ? 'YES ✅' : 'NO ❌'}</strong></li>
          <li>Countdown: <strong>{countdown} seconds</strong></li>
        </ul>
      </div>

      <div style={{ padding: '1rem', background: '#fff3cd', borderRadius: '8px', border: '1px solid #d4a574' }}>
        <strong>Note:</strong> This is a test page only. The actual session timeout
        uses the <code>useSessionTimeout</code> hook in App.tsx with real inactivity detection.
      </div>
